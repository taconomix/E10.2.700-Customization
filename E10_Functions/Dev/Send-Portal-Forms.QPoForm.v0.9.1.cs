/*== QP O-Form Auto-Email v0.9.1 =================================================================

	Library:  Send-Portal-Forms
	Function: Send-QPOForm
	Version:  Send-Portal-Forms.QPoForm.v0.9.1.cs
...
//Use the Company_UD fields to replace these strings;
	...
	//var SS = Db.Company.Where(x => x.Company == "SS").FirstOrDefault(); // WHY DOESN'T THIS WORK???
...
//__ Set Email Parameters ________________________________________________
	...
	body.Append(String.Format("Attached is the Surestep Orthometry Form for your order #{0}, line {1}. Please review, and let us know as quickly as possible if you find any incorrect information. Note that remake orders and any order with free-form Order Notes will be reviewed prior to fabrication, so this O-Form may slightly change before fabrication begins.",sOrderNum,sOrderLine).AppendLine();
	...
	string attachmentName = String.Format("Surestep O-Form {0}-{1}.pdf",sOrderNum,sOrderLine);
